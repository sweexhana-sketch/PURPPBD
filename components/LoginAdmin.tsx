            ...
            <div className="bg-white rounded-3xl shadow-2xl w-full max-w-md overflow-hidden">
                ...
                <div className="p-8">
                    <form onSubmit={handleLogin} className="space-y-6">
                        {error && (
                            <div className="bg-red-50 text-red-600 p-4 rounded-xl text-sm font-bold flex items-center">
                        ...
                        <div>
                            <label className="block text-gray-700 font-bold mb-2 ml-1">Email Admin</label>
