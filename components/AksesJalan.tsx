                ...
                <section className="bg-white rounded-3xl shadow-lg p-8 md:p-12 border border-gray-100">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-10">
                        <div className="bg-gray-50 rounded-2xl p-6 text-center border border-gray-100 shadow-sm">
                            <div className="text-3xl font-black text-green-600">1.055,19</div>
                            <div className="text-xs font-semibold text-gray-500 mt-1 uppercase tracking-wide">km</div>
                            <div className="text-sm text-gray-600 mt-2 font-medium">Total Panjang Jalan Provinsi</div>
                        </div>
                        <div className="bg-gray-50 rounded-2xl p-6 text-center border border-gray-100 shadow-sm">
                            <div className="text-3xl font-black text-green-600">36</div>
                            <div className="text-xs font-semibold text-gray-500 mt-1 uppercase tracking-wide">ruas</div>
                            <div className="text-sm text-gray-600 mt-2 font-medium">Jumlah Ruas Jalan Provinsi</div>
                        </div>
                        <div className="bg-gray-50 rounded-2xl p-6 text-center border border-gray-100 shadow-sm">
                            <div className="text-3xl font-black text-green-600">61</div>
                            <div className="text-xs font-semibold text-gray-500 mt-1 uppercase tracking-wide">%</div>
                            <div className="text-sm text-gray-600 mt-2 font-medium">Kondisi Mantap</div>
                        </div>
                        <div className="bg-gray-50 rounded-2xl p-6 text-center border border-gray-100 shadow-sm">
                            <div className="text-3xl font-black text-green-600">312</div>
                            <div className="text-xs font-semibold text-gray-500 mt-1 uppercase tracking-wide">unit</div>
                            <div className="text-sm text-gray-600 mt-2 font-medium">Jumlah Jembatan</div>
                        </div>
                    </div>

                    {/* Kondisi Kemantapan Jalan Provinsi */}
                    <div className="bg-gray-50 rounded-2xl p-6 border border-gray-100">
                        <h3 className="font-bold text-gray-800 mb-5">Kondisi Kemantapan Jalan Provinsi</h3>
                        <div className="space-y-4">
                            {[
                                { label: 'Baik', value: 42, color: 'bg-green-500' },
                                { label: 'Sedang', value: 19, color: 'bg-yellow-400' },
                                { label: 'Rusak Ringan', value: 23, color: 'bg-orange-400' },
                                { label: 'Rusak Berat', value: 16, color: 'bg-red-500' },
                            ].map(item => (
                                <div key={item.label} className="flex items-center gap-4">
                                    <div className="w-24 text-sm font-semibold text-blue-700 flex-shrink-0">{item.label}</div>
                                    ...
                                    <div className="w-10 text-sm font-bold text-gray-700 text-right">{item.value}%</div>
                                </div>
                            ))}
                        </div>
                    </div>
                            ...
                            <div className="bg-blue-50 border-l-4 border-blue-500 p-6 rounded-r-2xl">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="flex items-center space-x-2">
                                        ...
                                        <span className="text-gray-700">0811-4190-2984</span>
                                    </div>
                                </div>
                            </div>
                        </div>
