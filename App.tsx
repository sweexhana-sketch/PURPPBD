...
const HomePage: React.FC = () => {
  const [isRTLHModalOpen, setIsRTLHModalOpen] = useState(false);
  ...
  <main className="flex-grow">
    ...
    <section id="layanan" className="relative -mt-12 z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      {/* RTLH Banner */}
      <div className="bg-yellow-500 rounded-3xl p-8 md:p-10 shadow-2xl flex flex-col md:flex-row items-center justify-between text-blue-900 relative overflow-hidden">
        ...
        <div className="relative z-10 md:w-2/3 mb-6 md:mb-0">
          <div className="flex items-center mb-4">
            <i className="fas fa-home text-4xl mr-4"></i>
            <h2 className="text-3xl font-extrabold">Bantuan Rumah Tidak Layak Huni</h2>
          </div>
          <p className="text-blue-900/80 text-lg font-medium leading-relaxed">
            Masyarakat perorangan bisa menerima bantuan langsung berupa bahan bangunan atau uang tunai untuk rehabilitasi rumah yang tidak layak huni berdasarkan skala prioritas dan kriteria kawasan.
          </p>
        </div>
        <div className="relative z-10 md:w-1/3 flex justify-end">
          <button 
            onClick={() => setIsRTLHModalOpen(true)}
            className="bg-blue-900 text-white hover:bg-blue-800 px-8 py-4 rounded-xl font-bold text-lg shadow-xl transition-all active:scale-95 flex items-center"
          >
    ...
    <RTLHModal isOpen={isRTLHModalOpen} onClose={() => setIsRTLHModalOpen(false)} />
